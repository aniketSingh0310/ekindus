...
export async function POST(req) {
    try {
        ...
        const transporter = nodemailer.createTransport({
            host: 'smtp-relay.brevo.com', // Replace with your SMTP host (e.g., smtp.gmail.com for Gmail)
            port: 587, // Use port 465 for secure connections or 587 for TLS
            secure: false, // true for 465, false for other ports
            auth: {
                user: '7cc5f6001@smtp-brevo.com', // Replace with your SMTP email
                pass: 'Abc8NPwDT0LBQJp4', // Replace with your SMTP email password or app password
            },
        });

        // Send an email
        const info = await transporter.sendMail({
            from: '7cc5f6001@smtp-brevo.com', // Replace with your name and email
            to: 'aniketfcb10@gmail@gmail.com', // The recipient email
