        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-[4rem] py-10 md:px-0 px-3">
          <div className="relative bg-white py-5 px-10 shadow-md">
            ...
            <div className="flex flex-col">
              <p className="text-left p-6 text-base font-[family-name:var(--font-rethink)] tracking-[-0.020em] md:h-[150px]">
          ...
          <div className="relative bg-white py-5 px-10 shadow-md">
            ...
            />
            <div className="flex flex-col">
              <p className="text-left p-8 text-base font-[family-name:var(--font-rethink)] tracking-[-0.020em] md:h-[150px]">
          ...
          <div className="relative bg-white py-5 px-10 shadow-md md:col-span-2 max-w-xl mx-auto">
            ...
            />
            <div className="flex flex-col">
              <p className="text-left p-5 text-base font-[family-name:var(--font-rethink)] tracking-[-0.020em]">
